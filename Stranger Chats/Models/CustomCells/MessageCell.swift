    ...
    var messageDate: UILabel!
        ...
        override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
            ...
            NSLayoutConstraint.activate([
                ...
                messageBubble.leadingAnchor.constraint(equalTo: leadingAnchor, constant: 15),
                ...
                messageDate.leadingAnchor.constraint(equalTo: messageBubble.trailingAnchor, constant: 6),
